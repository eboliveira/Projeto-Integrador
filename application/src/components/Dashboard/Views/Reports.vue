                ...
                <card style="padding: 15px;">
							...
							<b-row>
								...
								<b-col md="12" class="my-1">
									<b-form-select v-model="searchData.filter.type" :options="searchData.filter.options" slot="prepend">
										<option :value="null" >Sem desativado</option>
								...
								<b-col md="12" class="my-1">
									<b-form-input class="text-center" v-if="searchData.filter.type" v-model="searchData.filter.value" :placeholder="filterPlaceholder"/>
								</b-col>
							</b-row>
						</b-col>
					</b-row>
					...
					<b-row>
						<b-col md="6" class="my-1">
							<b-form-group vertical label="Buscar" class="mb-0">
								<b-input-group>
						...
						<b-col md="6" class="my-1">
							<b-form-group vertical label="Por página:" class="mb-0">
