        ...
        <b-row>
          	<b-col md="12">
        		...
        		<v-layout justify-center style="margin-top: 20px; margin-bottom: 20px">
					<b-btn variant="success" v-on:click="dialog = true">Procurar Salas<i class="fa fa-search"></i></b-btn>
					...
					<b-btn variant="info" style="margin-left: 10px;" v-on:click="info=true, editable = false"><v-icon>mdi-information-variant</v-icon></b-btn>
...
export default {
  ...
  methods: {
    ...
    search() {
      var start = moment(this.eventsData[0].start)
        .utc()
        .format("YYYY-MM-DDTHH:mm:ss.sss");
      var end = moment(this.eventsData[0].end)
        .utc()
        .format("YYYY-MM-DDTHH:mm:ss.sss");
